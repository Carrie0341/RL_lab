...
class VisualFactorySimpleNetwork(network_builder.NetworkBuilder.BaseNetwork):
...
class VisualFactorySimpleNetworkBuilder(network_builder.NetworkBuilder):
    ...
    def build(self, name, **kwargs):
        return VisualFactorySimpleNetwork(self.params, **kwargs)
...
# 註冊網絡
model_builder.register_network('visual_factory_simple', VisualFactorySimpleNetworkBuilder)
